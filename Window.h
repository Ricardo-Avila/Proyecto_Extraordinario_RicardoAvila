...
public:
	...
	GLboolean getAnimacionLuminocidad() { return animacionLuminocidad; }
	GLvoid setAnimacionLuminocidad(bool activacion) { animacionLuminocidad = activacion; }
	bool getShouldClose() {
...
private: 
	...
	GLboolean animacionLuminocidad;
